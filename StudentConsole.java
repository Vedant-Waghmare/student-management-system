	...
	void start() throws NumberFormatException, IOException
	{
		...
		while(true)
		{
			...
			else
			{
				System.out.println("Present... his/her data is");
				st.display();
				System.out.println("Do you really want to delete record?...Y/N");
				String check = br.readLine();
				if(check.equalsIgnoreCase("y"))
				{
				sdb.remove(st);
				System.out.println("Detete Operation Sucessful !");
				}
				else
			...
			case 6: System.out.println("Enter name to be edited");
			target=br.readLine();
			st=sdb.findByName(target);
			if(st==null)
				System.out.println("No such student");
			else
			{
				...
				System.out.println("Enter new data for this particular student");
				System.out.println("Enter data.. r,n,m");
				rollno=Integer.parseInt(br.readLine());
				name=br.readLine();
				marks=Float.parseFloat(br.readLine());
				st=new Student(rollno, name, marks);
				sdb.set(pos,st);
				System.out.println("Edit Operation Sucessful !");
			}
				break;
